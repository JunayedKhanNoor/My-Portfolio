...
const Footer = () => {
  return (
    <div>
      <footer className="footer footer-center p-3 bg-gradient-to-r from-indigo-600 to-neutral text-primary-content">
        <div>
          <svg
            width="50"
            height="50"
        ...
        <div className="flex gap-3">
                  <span
                    ...
                    className=" bg-white rounded-full text-white text-lg  flex p-2"
                    role="button"
                  >
                    <div className="mr-2">
                  ...
                  <span
                    ...
                    className=" text-white bg-white rounded-full text-lg  flex p-2"
                    role="button"
                  >
                    <div className="mr-2">
